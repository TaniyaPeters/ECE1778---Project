        ...
        >
            <View style={styles.overlay}>
                <View style={styles.modalBox}>
                    <Text style={[globalStyles.titleText, styles.title]}>Your Rating and Review</Text>
                    
                    {/*Input for rating*/}
                    <Text style={[globalStyles.paragraphBold, styles.labelText]}>Rating:</Text>
                    ...
                    {/*Input for review*/}
                    <Text style={[globalStyles.paragraphBold, styles.labelText]}>Review:</Text>
                    <TextInput
                    ...
                    <View style={styles.buttonContainer}>
                        <Pressable
                            ...
                            onPress={onClose}
                        >
                            <Text style={[globalStyles.paragraphBold, styles.buttonText]}>Cancel</Text>
                        </Pressable>
                        <Pressable
                            style={({ pressed }: { pressed: boolean }) => [
                        ...
                        >
                            <Text style={[globalStyles.paragraphBold, styles.buttonText]}>Submit</Text>
                        </Pressable>
                    </View>
                </View>
            </View>
