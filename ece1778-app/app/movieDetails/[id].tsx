...
export default function movieDetails() {
    ...
    const description: string = "An orphaned boy enrolls in a school of wizardry, where he learns the truth about himself, his family and the terrible evil that haunts the magical world.";
    const rating: number = 3.85;
    const num_ratings: number = 879;
    const reviews: Review[] = [{id: 1, user: "bob123", text: "This movie is a delight for those of all ages. I have seen it several times and each time I am enchanted by the characters and magic. The cast is outstanding, the special effects delightful, everything most believable."},{id: 2, user: "lesley67", text: "I know I'm probably the only one that didn't care for this film, but I thought it was plain boring. The adaptation of the book is just OK and the acting is average."}];
    ...
    return (
        <ScrollView style={globalStyles.container}>
            ...
            <View style={styles.ratingContainer}>
                <Text style={[globalStyles.paragraph, styles.rating]}>⭐ {rating} / 5</Text>
                <Text style={[globalStyles.paragraph, styles.num_ratings]}> ({num_ratings} ratings)</Text>
            </View>

            {/* Movie poster */}
            <Image source={moviePoster} style={globalStyles.detailsImage} resizeMode="contain"/>
            ...
            <Card style={styles.card}>
                ...
                <View style={styles.verticalContainer}>
                    ...
                    {cast.map((actor, index) => (
                        <Text key={index} style={globalStyles.paragraph}>{actor}</Text>
                    ))}
                </View>
            </Card>
